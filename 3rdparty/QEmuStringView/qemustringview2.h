...
qsizetype findString(QEmuStringView haystack0, qsizetype from, QEmuStringView needle0, Qt::CaseSensitivity cs) noexcept;
...
public:
	...
	template <typename Char, if_compatible_char<Char> = true>
	Q_DECL_CONSTEXPR QEmuStringView(const Char *str)
		: QEmuStringView(str, str ? lengthHelper(str) : 0) {}
