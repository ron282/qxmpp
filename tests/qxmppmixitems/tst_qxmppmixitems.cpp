...
void tst_QXmppMixItem::testConfig()
{
    ...
    QVERIFY(!item1.nicknameRequired().has_value());
    QVERIFY(!item1.presenceRequired().has_value());
    QVERIFY(!item1.onlyParticipantsPermittedToSubmitPresence());
    QVERIFY(!item1.ownMessageRetractionPermitted().has_value());
    QVERIFY(!item1.invitationsPermitted().has_value());
    QVERIFY(!item1.privateMessagesPermitted().has_value());
    ...
    QCOMPARE(item1.messagesSubscribeRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item1.messagesRetractRole().value(), QXmppMixConfigItem::Role::Nobody);
    QCOMPARE(item1.presenceSubscribeRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item1.participantsSubscribeRole().value(), QXmppMixConfigItem::Role::Administrator);
    QCOMPARE(item1.informationSubscribeRole().value(), QXmppMixConfigItem::Role::Anyone);
    QCOMPARE(item1.informationUpdateRole().value(), QXmppMixConfigItem::Role::Owner);
    QCOMPARE(item1.allowedJidsSubscribeRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item1.bannedJidsSubscribeRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item1.configurationReadRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item1.avatarUpdateRole().value(), QXmppMixConfigItem::Role::Participant);
    QVERIFY(item1.nicknameRequired().has_value());
    QVERIFY(!*item1.nicknameRequired());
    QVERIFY(item1.presenceRequired().has_value());
    QVERIFY(*item1.presenceRequired());
    QVERIFY(item1.onlyParticipantsPermittedToSubmitPresence().has_value());
    QVERIFY(!*item1.onlyParticipantsPermittedToSubmitPresence());
    QVERIFY(item1.ownMessageRetractionPermitted().has_value());
    ...
    QCOMPARE(item2.messagesSubscribeRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item2.messagesRetractRole().value(), QXmppMixConfigItem::Role::Nobody);
    QCOMPARE(item2.presenceSubscribeRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item2.participantsSubscribeRole().value(), QXmppMixConfigItem::Role::Administrator);
    QCOMPARE(item2.informationSubscribeRole().value(), QXmppMixConfigItem::Role::Anyone);
    QCOMPARE(item2.informationUpdateRole().value(), QXmppMixConfigItem::Role::Owner);
    QCOMPARE(item2.allowedJidsSubscribeRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item2.bannedJidsSubscribeRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item2.configurationReadRole().value(), QXmppMixConfigItem::Role::Allowed);
    QCOMPARE(item2.avatarUpdateRole().value(), QXmppMixConfigItem::Role::Participant);
    QVERIFY(item2.nicknameRequired().has_value());
    QVERIFY(!*item2.nicknameRequired());
    QVERIFY(item2.presenceRequired().has_value());
    QVERIFY(*item2.presenceRequired());
    QVERIFY(item2.onlyParticipantsPermittedToSubmitPresence().has_value());
    QVERIFY(!*item2.onlyParticipantsPermittedToSubmitPresence());
    QVERIFY(item2.ownMessageRetractionPermitted().has_value());
    QVERIFY(*item2.ownMessageRetractionPermitted());
    QVERIFY(item2.invitationsPermitted().has_value());
    QVERIFY(*item2.invitationsPermitted());
    QVERIFY(item2.privateMessagesPermitted().has_value());
