...
const char*ns_stream_error ="urn:ietf:params:xml:ns:xmpp-streams";
...
// XEP-0048: Bookmarks
const char*ns_bookmarks ="storage:bookmarks";
...
// XEP-0386: Bind 2
const char*ns_bind2 ="urn:xmpp:bind:0";
// XEP-0388: Extensible SASL Profile
const char*ns_sasl_2 ="urn:xmpp:sasl:2";
